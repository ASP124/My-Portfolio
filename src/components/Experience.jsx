    ...
    return (
        <div id="experience" className="border-b border-neutral-900 pb-4">
            ...
            <div>
                ...
                (
                    <div key={index} className="pb-8 mb-8 flex flex-wrap lg:justify-center">
                        <motion.div whileInView={{opacity:1,x:0}}
                        initial={{opacity:0, x:-100}}
                        transition={{duration:1}} className="w-full lg:w-1/4">
                            <p className="mb-2 text-l text-neutral-400">{experience.year}</p>
                        </motion.div>
                        <motion.div whileInView={{opacity:1,x:0}}
                        initial={{opacity:0, x:100}}
                        transition={{duration:1}}className="w-full max-w-xl lg:w-3/4">
                            <h6 className="mb-2 text-xl font-semibold">{experience.role} - <span className="text-[16px] text-purple-100">{experience.company}</span></h6>
